...
from data.dataset_net1 import LLD_dataset, RandomGenerator
...
def trainer_lld(args, model, lld_path):
    logging.basicConfig(filename=lld_path + "/log_net1.txt", level=logging.INFO,
    ...
    db_train = LLD_dataset(base_dir=args.root_path, lld_dir=args.lld_dir, split="train_net1",
                            transform=transforms.Compose(
                                [RandomGenerator(output_size=[args.img_size, args.img_size])]))
    db_val = LLD_dataset(base_dir=args.root_path, lld_dir=args.lld_dir, split="val_net1")
